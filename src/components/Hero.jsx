    ...
    <section id="home" className={`flex md:flex-row flex-col ${styles.paddingY} `} >
      <div className={`flex-1 ${styles.flexStart} flex-col xl:px-0 sm:px-16 px-6 overflow-hidden`} >
        ...
        <p className={`${styles.paragraph} max-w-[470px] mt-5 `}>
          Step into a world where speed meets security. Our advanced payment system adapts to you — fast, seamless, and built for the future.
        </p>
      </div>
      ...
      <div className={`flex-1 flex ${styles.flexCenter} md:my-0 my-10 relative group`}>
        <img 
          src={robot} 
          alt="billing" 
          className="w-[100%] h-[100%] relative z-[5] object-contain transition-transform duration-500 ease-in-out group-hover:scale-105 group-hover:brightness-110" 
        />
